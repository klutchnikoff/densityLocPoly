...
saveRDS(r_lp0, file = "data/rlp0-k2.1-Nobs1000.rds")
saveRDS(r_lp1, file = "data/rlp1-k2.1-Nobs1000.rds")
saveRDS(r_lp2, file = "data/rlp2-k2.1-Nobs1000.rds")
saveRDS(r_sparr, file = "data/rsparr-k2.1-Nobs1000.rds")
